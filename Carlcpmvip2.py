...
if __name__ == "__main__":
    ...
    while True:
        ...
        while True:
            ...
            console.print("[bold cyan][bold white](34)[/bold white]: Change Account Password        [bold red]100[/bold red][/bold cyan]")
            console.print("[bold cyan][bold white](35)[/bold white]: Change Account Email           [bold red]100[/bold red][/bold cyan]")
