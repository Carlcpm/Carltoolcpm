...
def get_service_costs():
    ...
    return {
        ...
        "unlock_slots": 7000,
        "copy_cpm2_car_to_cpm2": 10000 
        "copy_cpm2_car_to_cpm2": 10000  
        "unlock_all_flags": 25000
        "unlock_police_kits": 35000
        "register_vip_unlimited": 50000
        "add_car": 10000
    }
        ...
        while True:
            ...
            while True: # Submenu loop
                ...
                if main_menu == "2": # CPM2 specific options
                    ...
                    print(f"15. 🔄 COPY CPM1 CARS TO CPM2 (Cost: {service_costs.get('copy_cpm1_car_to_cpm2', 10000)} coins)") 
                    print(f"16. 🚗 COPY CPM2 CARS TO CPM2 (Cost: {service_costs.get('copy_cpm2_cars_to_cpm2', 10000)} coins)")
                ...
                elif choice == "16" and main_menu == "2": # COPY CPM2 CARS TO CPM2 (CPM2 only)
