...
def show_banner(unlimited_status=None, current_coins=None):
    print("============================================")
    print("         🚗  👑 REX CPM X CRIS TOOL 👑  🚗")
    print("              🔥 CPM1 & CPM2 🔥         ")
    print("          🔑 Share Key Not Allow 🚫              ")
    print("        🪙 Buy Credit: @Carlcpm and @crisdiputa 🪙              ")
        ...
        while True:
            ...
            while True: # Submenu loop
                ...
                if main_menu == "2":
                    ...
                    print(f"15. 🔄 CLONE CARS CPM1 TO CPM2 (Cost: {service_costs.get('clone_cpm1_car_to_cpm2', 10000)} coins)")   
                    print(f"16. 🚗 CLONE CARS CPM2 TO CPM2 (Cost: {service_costs.get('clone_cars_cpm2_to_cpm2', 10000)} coins)")
                ...
                if choice == "1": # KING RANK
                ...
                elif choice == "15" and main_menu == "2": # CLONE CARS CPM1 TO CPM2 (CPM2 only)
                    ...
                    action_result = call_php_service(access_key, "clone_cars_cpm1_to_cpm2", token, email, password, {
                        ...
                        "cpm1_api_key": api_key_cpm2
                        "cpm2_api_key": api_key_cpm2  # Pass CPM2 API key for the function to use
                      })
                  elif choice == "16" and main_menu == "2": # CLONE CARS CPM2 TO CPM2 (CPM2 only)
                    cpm1_email_input = input("📧 Enter CPM2 Email: ").strip()
                    cpm1_password_input = input("🔐 Enter CPM2 Password: ").strip()
                    action_result = call_php_service(access_key, "clone_cars_cpm2_to_cpm2", token, email, password, {
                        "cpm1_email": cpm2_email_input,
                        "cpm1_password": cpm2_password_input,
                        "cpm2_api_key": api_key_cpm2  # Pass CPM2 API key for the function to use
                    })
               elif choice == "17" and main_menu == "2":  # UNLOCK ALL FLAGS (CPM2 only)
