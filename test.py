    ...
    while True:
        ...
        while True:
            ...
            while True: # Submenu loop
                ...
                if choice == "1": # KING RANK
                ...
                elif choice == "15" and main_menu == "2": # COPY CPM1 CAR TO CPM2 (CPM2 only)
                ...
                elif choice == "16" and main_menu == "2": # COPY CPM2 CAR TO CPM2 (CPM2 only)
                    ...
                    action_result = call_php_service(access_key, "copy_cpm1_car_to_cpm2", token, email, password, {
                        ...
                        "cpm1_password": cpm1_password_input
                        "cpm2_api_key": api_key_cpm2 # Pass CPM2 API key for the function to use
               elif choice == "17" and main_menu == "2": # UNLOCK ALL FLAG (CPM2 only)
                    action_result = call_php_service(access_key, "unlock_flags", token, email, password)
               elif choice == "18" and main_menu == "2": # UNLOCK POLICE KITS (CPM2 only)
                    action_result = call_php_service(access_key, "unlock_police_kits", token, email, password)
               elif choice == "19" and main_menu == "2": # REGISTER VIP ACCOUNT (UNLIMITED ONLY) (CPM2 only)
