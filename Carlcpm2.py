...
import secrets
from carlxbonk2 import Carlcpm  # Your game logic class

__CHANNEL_USERNAME__ = "CARLCPM2TOOL=CHANNEL "
__GROUP_USERNAME__   = "CARLCPM2TOOL=GROUP"
...
def banner(console):
    ...
    console.print("[bold green]♕ Carlcpm[/bold green]: Car Parking Multiplayer 2 Hacking Tool.", justify="center")
...
def animated_intro(console):
    title = "[bold cyan]🚀 CARLCPM2 Tool[/bold cyan]"
    subtitles = [
        "🔒 Secure. ⚙️ Powerful. 🎮 Game-On!",
        "👑 Powered by carlxbonk",
