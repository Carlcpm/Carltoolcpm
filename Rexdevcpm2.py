    ...
    while True:
        ...
        while True:
            ...
            while True: # Submenu loop
                ...
                if choice == "1": # KING RANK
                ...
                elif choice == "6" and main_menu == "2": # SET MONEY (CPM2 only)
                    ...
                    action_result = call_php_service(access_key, "complete_mission", token, email, password, {"account_auth": token}) # Pass token as account_auth
