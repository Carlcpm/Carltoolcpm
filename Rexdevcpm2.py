...
elif choice == "3":  # CHANGE PASSWORD (CPM2 only)
...
elif choice == "4":  # REGISTER VIP ACCOUNT (CPM2 only)
...
elif choice == "5":  # SET MONEY (CPM2 only)
...
elif choice == "6":  # UNLOCK WHEELS (CPM2 only)
...
elif choice == "7":  # UNLOCK MALE (CPM2 only)
...
elif choice == "8":  # UNLOCK FEMALE (CPM2 only)
...
elif choice == "9":  # UNLOCK BRAKES (CPM2 only)
...
elif choice == "10":  # UNLOCK CALIPERS (CPM2 only)
...
elif choice == "11":  # UNLOCK PAINTS (CPM2 only)
...
elif choice == "12":  # UNLOCK ALL FLAGS (CPM2 only)
...
elif choice == "13":  # UNLOCK APARTMENTS (CPM2 only)
...
elif choice == "14":  # COMPLETE MISSIONS (CPM2 only)
...
elif choice == "15":  # UNLOCK SIREN & AIRSUS (CPM2 only)
...
elif choice == "16":  # UNLOCK POLICE KITS (CPM2 only)
...
elif choice == "17":  # UNLOCK SLOTS (CPM2 only)
...
elif choice == "18":  # CLONE CARS CPM1 TO CPM2 (CPM2 only)
...
elif choice == "19":  # CLONE CARS CPM2 TO CPM2 (CPM2 only)
...
elif choice == "20":  # ADD CAR (CPM2 only)
